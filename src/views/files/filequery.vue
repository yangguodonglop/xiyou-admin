...
<section class="chart-container">
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
        <el-form :inline="true" ref="findForm" :model="findForm">
            <el-form-item label="开始时间">
                <el-date-picker v-model="findForm.startTime" type="datetime" @change="getSTimestart" value-format="yyyy-MM-dd HH:mm" placeholder="选择日期时间">
                </el-date-picker>
            </el-form-item>
            <el-form-item label="结束时间">
                <el-date-picker v-model="findForm.endTime" @change="getSTimeend" type="datetime" value-format="yyyy-MM-dd HH:mm" placeholder="选择日期时间">
                </el-date-picker>
            </el-form-item>
    ...
    <template>
        ...
        <el-col :span="24" class="toolbar">
            <el-pagination @size-change="handleSizeChangeCx" @current-change="handleCurrentChangeCx" :current-page="currentPageCx" :page-sizes="[5, 10, 20]" :page-size="pagesizeCx" layout="total, sizes, prev, pager, next, jumper" style="float:right" :total="tableData.length">
            </el-pagination>
        </el-col>
    </template>
                ...
                <el-tab-pane label="备份/缓存数量" name="first">
                    <el-col :span="24">
                        ...
                        <div class="item_title_child">
                            ...
                            <el-pagination @size-change="handleSizeChangeBf" @current-change="handleCurrentChangeBf" :current-page="currentPageBf" :page-sizes="[5, 10, 20]" :page-size="pagesizeBf" layout="total, sizes, prev, pager, next, jumper" style="float:right" :total="tableDataBf.length">
                            </el-pagination>
                        </div>
                    </el-col>
                </el-tab-pane>
                <el-tab-pane label="文件拥有者" name="second">
                    <el-col :span="24">
                        ...
                        <div class="item_title_child">
                            ...
                            <el-pagination @size-change="handleSizeChangeYyz" @current-change="handleCurrentChangeYyz" :current-page="currentPageYyz" :page-sizes="[5, 10, 20]" :page-size="pagesizeYyz" layout="total, sizes, prev, pager, next, jumper" style="float:right" :total="tableDataYyz.length">
                            </el-pagination>
                        </div>
                    </el-col>
                ...
                <el-tab-pane label="日志记录" name="third">
                    <el-col :span="24">
                        ...
                        <div class="item_title_child">
                            ...
                            <el-pagination @size-change="handleSizeChangeRz" @current-change="handleCurrentChangeRz" :current-page="currentPageRz" :page-sizes="[5, 10, 20]" :page-size="pagesizeRz" layout="total, sizes, prev, pager, next, jumper" style="float:right" :total="tableDataRzjl.length">
                            </el-pagination>
                        </div>
                    </el-col>
                </el-tab-pane>
    ...
    <el-dialog title="" :visible.sync="dialogCacheVisible" customClass="customWidth">
        <div class="dialog_item_title" style="display:flex;flex-direction: column;">
            ...
            <div>
                <el-pagination @size-change="handleSizeChangeJd" @current-change="handleCurrentChangeJd" :current-page="currentPageJd" :page-sizes="[5, 10, 20]" :page-size="pagesizeJd" layout="total, sizes, prev, pager, next, jumper" style="float:right;margin-top:20px;margin-bottom:0px;" :total="tableDataDetails.length">
                </el-pagination>
            </div>
    ...
    methods: {
        ...
        handleDetails(index, row) {
            this.$router.push({
                ...
                query: {
                    tabActive: "second",
                    nowStoreNodeId: row.storeNodeId
                }
            });
        },
    }
