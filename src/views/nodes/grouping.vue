                ...
                <div class="grid-content bg-purple new_grid-content">
                    <div style="display: flex;justify-content: space-between;">
                        <div class="item_three_table" style="margin-top:10px;">
                            ...
                            <el-pagination @size-change="handleSizeChangeFq" @current-change="handleCurrentChangeFq" :current-page="currentPageFq" :page-sizes="[5, 10, 20]" :page-size="pagesizeFq" layout="total, sizes, prev, pager, next, jumper" style="float:right" :total="tableGroupInfo.length">
                            </el-pagination>
                ...
                <el-tab-pane label="分组详情" name="firstBackUp">
                    <el-col :span="24">
                        <div class="item_title_child" style="text-align:left;">
                            ...
                            <el-pagination @size-change="handleSizeChangeGroup" @current-change="handleCurrentChangeGroup" :current-page="currentPageGroup" :page-sizes="[5, 10, 20]" :page-size="pagesizeGroup" layout="total, sizes, prev, pager, next, jumper" style="float:right" :total="queryGroupInfoLength">
                            </el-pagination>
                        </div>
                    </el-col>
                </el-tab-pane>
